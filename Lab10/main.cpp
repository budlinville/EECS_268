...
//******************still need to handle invalid user input *****************
...
//when searching for/removing an entry, make sure to first check that the dictionary contains that entry;
//also make sure you handle the event that the user does not pass in correct argv paramaters
